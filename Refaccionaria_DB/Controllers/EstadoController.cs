...
namespace Refaccionaria_DB.Controllers
{
    public class EstadoController : Controller
    {
        ...
        {
            var estado = db.Estado.Include(e => e.Usuario).Include(e => e.Usuario1);
        ...
        public ActionResult Create([Bind(Include = "idEstado,nombre,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idEstado,nombre,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Estado estado)
        {
            if (ModelState.IsValid)
            {
