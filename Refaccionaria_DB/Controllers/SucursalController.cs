...
namespace Refaccionaria_DB.Controllers
{
    public class SucursalController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idSucursal,nombre,direccion,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Sucursal sucursal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idSucursal,nombre,direccion,estatus,idUsuarioCrea,fechaCrea,idUsuarioModifica,fechaModifica")] Sucursal sucursal)
        {
            if (ModelState.IsValid)
            {
